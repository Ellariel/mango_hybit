...
pp.create_bus(net, name = "110 kV bar", vn_kv = 110, type = 'b') # bus 0
pp.create_bus(net, name = "20 kV bar", vn_kv = 20, type = 'b') # bus 1
pp.create_bus(net, name = "bus_2", vn_kv = 20, type = 'b')
pp.create_bus(net, name = "bus_3", vn_kv = 20, type = 'b')
pp.create_bus(net, name = "bus_4", vn_kv = 20, type = 'b')

pp.create_ext_grid(net, 0, vm_pu = 1)

pp.create_line(net, name = "line_0", from_bus = 1, to_bus = 2, length_km = 1, std_type = "NAYY 4x150 SE")
pp.create_line(net, name = "line_1", from_bus = 1, to_bus = 3, length_km = 1, std_type = "NAYY 4x150 SE")
pp.create_line(net, name = "line_2", from_bus = 1, to_bus = 4, length_km = 1, std_type = "NAYY 4x150 SE")
...
pp.create_load(net, 2, p_mw = 1, q_mvar = 0.2, name = "load_0")
pp.create_load(net, 4, p_mw = 1, q_mvar = 0.2, name = "load_1")

pp.create_sgen(net, 3, p_mw = 1, name = "gen_0")
